...
-- /run for i = 1, GetNumRandomDungeons() do print(i, GetLFGRandomDungeonInfo(i)) end
-- /run for i = 1, GetNumRFDungeons() do print(i, GetRFDungeonInfo(i)) end
...
CallToArms.Text:SetShadowOffset(1.25, -1.25)
...
local CreateCTAConfig = function()
	...
	Config.Text:SetShadowOffset(1.25, -1.25)
	...
	UpdateIntOption.Text:SetShadowOffset(1.25, -1.25)
	...
	UpdateIntOption.EditBox:SetShadowOffset(1.25, -1.25)
	...
	WindowAlphaOption.Text:SetShadowOffset(1.25, -1.25)
	...
	WindowAlphaOption.EditBox:SetShadowOffset(1.25, -1.25)
